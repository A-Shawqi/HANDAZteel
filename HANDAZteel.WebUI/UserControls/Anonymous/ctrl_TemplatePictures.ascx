<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrl_TemplatePictures.ascx.cs" Inherits="HANDAZ.PEB.WebUI.UserControls.Anonymous.ctrl_TemplatePictures" %>
    ...
    <div class="container">
      <div class="row">
        <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
          <h2>Our Supported Frame Templates</h2>
          <p>We'll support more frame types in the next version isa</p>
        </div>
      </div> 
    </div>
