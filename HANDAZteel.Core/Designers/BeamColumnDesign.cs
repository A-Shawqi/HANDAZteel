...
{
    public static class BeamColumnDesign
    {
        ...
        public static bool CheckColumnBuckling(double Kfactor, double LbInPlan, double LbOutPlan, double Rx, double Ry, out double LmdaIn, out double LmdaOut, out double LmdaMax)
        {
            bool ColumnIsSafeForBucklingInPlan;
            bool ColumnIsSafeForBucklingOutPlan;
            bool ColumnIsSafeForBuckling;
