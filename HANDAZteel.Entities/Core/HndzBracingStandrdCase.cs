...
{
    /// <summary>
    /// Represents Structural steel bracing in the standard case (not tapered) with a generic profile
    /// </summary>
     [DataContract]  [Serializable]  [XmlSerializerFormat]
    public class HndzBracingStandrdCase:HndzBracing
    {
        #region properties
        #endregion
        ...
        /// </summary>
        public HndzBracingStandrdCase() : this( HndzResources.DefaultName, HndzResources.DefaultDescription, null, null)
        {
        }
