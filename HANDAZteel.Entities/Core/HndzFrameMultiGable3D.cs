...
namespace HANDAZ.Entities
{
    ...
    [Serializable]
    [XmlSerializerFormat]
    public class HndzFrameMultiGable3D : HndzFrame3D
    {
        ...
        [XmlArray("Frames2D")]
        public ICollection<HndzFrameMultiGable2D> Frames2D { get; set; }
